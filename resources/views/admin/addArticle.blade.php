        ...
        <div class="row">
            <div class="panel">
                ...
                <!--icons-->
                    ...
                    <form class="form-horizontal" method="post" action="{{ url('/admin/article/'. $cate_id .'/doAdd') }}">
                        {{ csrf_field() }}
                        <div class="form-group">
                            <label for="title" class="col-sm-2 control-label">文章标题</label>
                            <div class="col-sm-8">
                                <input name="title" type="text" class="form-control" id="title"
                                       value="{{ old('title') ? old('title') : '' }}" placeholder="请输入文章名称" required>
                            </div>
                            @if ($errors->has('title'))
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <input name="author" type="text" class="form-control" id="author"
                                       value="{{ old('author') ? old('author') : '' }}" placeholder="请输入作者名称" required>
                            </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <input name="comefrom" type="text" class="form-control" id="comefrom"
                                       value="{{ old('comefrom') ? old('comefrom') : '' }}" placeholder="请输入来源">
                            </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <input name="tag" type="text" class="form-control" id="tag"
                                       value="{{ old('tag') ? old('tag') : '' }}" placeholder="请输入文章标签">
                            </div>
                            @if ($errors->has('tag'))
                                <span class="help-block">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-5">
                                <input name="banner" type="text" class="form-control"
                                       ...
                                       id="banner" placeholder="请选择文章的Banner">
                            </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                <textarea name="digest" rows="3" class="form-control" id="digest" placeholder="请输入文章简介">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <input name="attachment" type="text" class="form-control"
                                       value="{{ old('attachment') ? old('attachment') : '' }}"
